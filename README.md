...
*everything is free.  stories are life.  share and enjoy.*

To replicate, buy a domain name, get a hosting account, and set up a raspberry pi web server to edit the code on.  Get email addresses on your domain name for 

 - operator@[your domain]
 - needs@[your domain]
 - freestuff@[your domain]
 - stories@[your domain]

Forward those email addresses to the personal emails of the human operators who will post to the feed scrolls.  The main operator recruits and organizes other operators.
